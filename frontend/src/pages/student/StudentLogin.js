  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.previous_selections) {
        localStorage.setItem("previous_selections", JSON.stringify(data.previous_selections));
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 font-display">Faculty Selection Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                autoFocus
              />
              <p className="text-xs text-slate-400 mt-1">Enter your registration PIN (case-insensitive)</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                autoComplete="off"
              />
              <p className="text-xs text-slate-400 mt-1">Format: DD/MM/YYYY (e.g. 01/01/2000)</p>
            </div>
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          Admin?{" "}
          <Link to="/admin/login" className="text-primary-600 hover:underline font-medium">
            Admin Login →
          </Link>
        </p>
      </motion.div>
